    ...
    options {
     ...
     stage('snyk test') {
            ...
            steps {
                ...
                sh "snyk container ignore --id=3320493 -q test --severity-threshold=critical --exclude-base-image-vulns kubealon/private-course:poly-bot-${env.BUILD_NUMBER} --file=Dockerfile"
